...
public class MowerServiceTest {
  ...
  @Test
  public void
      executeInstructionsReturnsExpectedPositionsWithErrorsWhenInvalidInstructionsProvided() {
  ...
  public void
    ...
    InstructionsCommands instructionsCommands =
        TestBuilder.buildInstructionsCommandsDuplicateMowerPosition();
    assertThrows(
        DuplicateMowerPositionException.class,
        () -> mowerService.executeInstructions(instructionsCommands));
  }

  @Test
  public void executeInstructionsThrowsInvalidDimensionsExceptionWhenInvalidDimensionsProvided() {
    InstructionsCommands instructionsCommands =
        TestBuilder.buildInstructionsCommandsInvalidDimensions();
    assertThrows(
  ...
  public void executeInstructionsThrowsDuplicateMowerIdExceptionWhenDuplicateMowerIdProvided() {
    InstructionsCommands instructionsCommands =
        TestBuilder.buildInstructionsCommandsDuplicateMowerId();
    assertThrows(
        DuplicateMowerIdException.class,
        () -> mowerService.executeInstructions(instructionsCommands));
  }
  ...
  public void executeInstructionsThrowsInvalidPositionExceptionWhenInvalidPositionProvided() {
    InstructionsCommands instructionsCommands =
        TestBuilder.buildInstructionsCommandsInvalidPosition();
    assertThrows(
  ...
  public void executeInstructionsThrowsInvalidInstructionExceptionWhenInvalidInstructionProvided() {
    InstructionsCommands instructionsCommands =
        TestBuilder.buildInstructionsCommandsInvalidInstruction();
    assertThrows(
        InvalidInstructionException.class,
        () -> mowerService.executeInstructions(instructionsCommands));
  }
}
