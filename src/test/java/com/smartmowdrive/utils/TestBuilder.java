...
public class TestBuilder {
    public static InstructionsRequestDTO buildInstructionsRequestDTO() {
        MowerInstructionsDTO mowerInstructionsDTO1 = MowerInstructionsDTO.builder()
                .id(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"))
                .startingPosition("1 2 N")
                .instructions("LMLMLMLMM")
                .build();

        MowerInstructionsDTO mowerInstructionsDTO2 = MowerInstructionsDTO.builder()
                .id(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa2"))
                .startingPosition("3 3 E")
                .instructions("MMRMMRMRRM")
                .build();

        List<MowerInstructionsDTO> mowersInstructions = Arrays.asList(mowerInstructionsDTO1, mowerInstructionsDTO2);
    ...
    public static InstructionsCommands buildInstructionsCommands() {
        ...
        List<MowerInstructions> mowersInstructions = Arrays.asList(mowerInstructions1, mowerInstructions2);
    ...
    public static InstructionsCommands buildInstructionsCommandsWithErrors() {
        ...
        List<MowerInstructions> mowersInstructions = Arrays.asList(mowerInstructions1, mowerInstructions2, mowerInstructions3);
        return new InstructionsCommands("5 5", mowersInstructions);
    }
    ...
    public static List<PositionResponseDTO> buildPositionResponseDTO() {
        PositionResponseDTO positionResponseDTO1 = PositionResponseDTO.builder()
                .x(1)
                .y(3)
                .position('N')
        ...
        PositionResponseDTO positionResponseDTO2 = PositionResponseDTO.builder()
                .x(5)
                .y(1)
                .position('E')
                .status("Instructions executed successfully")
    ...
    public static InstructionsCommands buildInstructionsCommandsDuplicateMowerPosition() {
        MowerInstructions mowerInstructions1 = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "1 2 N", "LMLMLMLMM");
        MowerInstructions mowerInstructions2 = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa2"), "1 3 N", "LMLMLMLMM");
    ...
    public static InstructionsCommands buildInstructionsCommandsInvalidDimensions() {
        MowerInstructions mowerInstructions = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "1 2 N", "LMLMLMLMM");
    ...
    public static InstructionsCommands buildInstructionsCommandsDuplicateMowerId() {
        MowerInstructions mowerInstructions1 = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "1 2 N", "LMLMLMLMM");
        MowerInstructions mowerInstructions2 = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "1 3 N", "LMLMLMLMM");
        return new InstructionsCommands("5 5", Arrays.asList(mowerInstructions1, mowerInstructions2));
    }

    public static InstructionsCommands buildInstructionsCommandsInvalidPosition() {
        MowerInstructions mowerInstructions = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "1 2 N N", "LMLMLMLMM");
    ...
    public static InstructionsCommands buildInstructionsCommandsInvalidInstruction() {
        MowerInstructions mowerInstructions = new MowerInstructions(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa1"), "1 2 N", "LMLMLMLMMX");
        return new InstructionsCommands("5 5", Collections.singletonList(mowerInstructions));
    }
}
