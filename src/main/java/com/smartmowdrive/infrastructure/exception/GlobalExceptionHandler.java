...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleDuplicateMowerPositionException(DuplicateMowerPositionException ex) {
        ApiError apiError = new ApiError(ex.getClass().getSimpleName(), HttpStatus.BAD_REQUEST, ex.getMessage());
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        ApiError apiError = new ApiError(ex.getClass().getSimpleName(), HttpStatus.BAD_REQUEST, errors.toString());
        return new ResponseEntity<>(apiError, apiError.getStatus());
    }
    ...
    public ResponseEntity<Object> handleGenericException(Exception ex) {
        ApiError apiError = new ApiError(ex.getClass().getSimpleName(), HttpStatus.INTERNAL_SERVER_ERROR, ErrorMessages.GENERIC_ERROR);
        return new ResponseEntity<>(apiError, apiError.getStatus());
    }

    @ExceptionHandler(NullPointerException.class)
    public ResponseEntity<Object> handleNullPointerException(NullPointerException ex) {
        ApiError apiError = new ApiError(ex.getClass().getSimpleName(), HttpStatus.INTERNAL_SERVER_ERROR, ErrorMessages.NULL_POINTER);
        return new ResponseEntity<>(apiError, apiError.getStatus());
    }
}
