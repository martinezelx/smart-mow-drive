...
public class RegexPatterns {
    ...
    public static final Pattern MOWER_POSITION = Pattern.compile("\\d+ \\d+ [" + Position.getValidChars() + "]");
    public static final Pattern INSTRUCTIONS = Pattern.compile("[" + Instruction.getValidChars() + "]+");
}
