...
public class ErrorMessages {
    ...
    public static final String DUPLICATE_MOWER_POSITION = "The starting position of this mower must not be the same as any final position of the previous ones:";
    ...
    public static final String OUT_OF_BOUNDS = "The starting position of this mower is out of bounds:";
